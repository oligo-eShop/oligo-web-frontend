      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">
              Oligo <span className="text-blue-400">eShop</span>
            </h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted destination for premium electronics and tech accessories. 
              We bring you the latest technology with unbeatable prices and excellent service.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Oligo eShop. All rights reserved. Built with Next.js and Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
